...
public:
    Index(const std::string path,   // ngt index path.
    ...
    void batchInsert(py::array_t<double> objects, size_t numThreads = 16, bool debug = false) {
    ...
    int insert(py::array_t<double> object, bool debug = false) {
    ...
    py::object search(
        ...
        float expectedAccuracy = -1.0,  // expected accuracy. if this is specified, epsilon that is calculated from this is used for search
                                        // instead of the specified epsilon.
    ...
    py::object linearSearch(py::object query,
                            size_t size = 0,  // the number of resultant objects
                            bool withDistance = true) {
        py::array_t<float> qobject(query);
        py::buffer_info qinfo = qobject.request();
    ...
    void refineANNG(float epsilon,           // epsilon for search
    ...
    void set(size_t numOfSearchObjects,  // the number of resultant objects
...
public:
    ...
    int optimizeNumberOfEdgesForANNG(const std::string path,  // anng index path
                                     int numOfQueries,
                                     int numOfResults,
                                     int numOfThreads,
...
public:
    QuantizedIndex(const std::string path,   // ngt index path.
...
PYBIND11_MODULE(ngtpy, m) {
    ...
    py::class_<Index>(m, "Index")
        ...
        .def("linear_search", &::Index::linearSearch, py::arg("query"), py::arg("size") = 0, py::arg("with_distance") = true)
        ...
        .def("remove", &::Index::remove, py::arg("object_id"))
        .def("build_index", &NGT::Index::createIndex, py::arg("num_threads") = 8, py::arg("target_size_of_graph") = 0)
        .def("get_object", &::Index::getObject, py::arg("object_id"))
        .def("batch_insert", &::Index::batchInsert, py::arg("objects"), py::arg("num_threads") = 8, py::arg("debug") = false)
        .def("insert", &::Index::insert, py::arg("object"), py::arg("debug") = false)
        .def("refine_anng",
             &::Index::refineANNG,
             py::arg("epsilon") = 0.1,
        ...
        .def("set",
             ...
             py::arg("edge_size") = INT_MIN,
             py::arg("expected_accuracy") = -FLT_MAX)
        .def("export_index", (void (NGT::Index::*)(const std::string&))&NGT::Index::exportIndex, py::arg("path"))
        .def("import_index", (void (NGT::Index::*)(const std::string&))&NGT::Index::importIndex, py::arg("path"));
    ...
    py::class_<Optimizer>(m, "Optimizer")
        .def(py::init<int, int, int, int, float, float, float, float, double, double, bool>(),
             ...
             py::arg("margin") = -1.0,
             py::arg("log_disabled") = false)
        .def("execute", &NGT::GraphOptimizer::execute, py::arg("in_path"), py::arg("out_path"))
        .def("adjust_search_coefficients", &NGT::GraphOptimizer::adjustSearchCoefficients, py::arg("path"))
        .def("set",
             (void (NGT::GraphOptimizer::*)(int, int, int, int, float, float, float, float, double, double))&NGT::GraphOptimizer::set,
             py::arg("num_of_outgoings") = -1,
             py::arg("num_of_incomings") = -1,
             py::arg("num_of_queries") = -1,
             py::arg("num_of_objects") = -1,
             ...
             py::arg("gt_epsilon") = -DBL_MAX,
             py::arg("margin") = -1.0)
        .def("set_processing_modes",
             &NGT::GraphOptimizer::setProcessingModes,
        ...
        .def("optimize_search_parameters", &NGT::GraphOptimizer::optimizeSearchParameters, py::arg("path"))
        .def("optimize_number_of_edges_for_anng",
             &::Optimizer::optimizeNumberOfEdgesForANNG,
             py::arg("path"),
             py::arg("num_of_queries") = -1,
    ...
    py::class_<QuantizedIndex>(m, "QuantizedIndex")
        .def(py::init<const std::string&, size_t, bool, bool, bool>(),
             ...
             py::arg("log_disabled") = false)
        .def("search",
             &::QuantizedIndex::search,
             py::arg("query"),
             py::arg("size") = 0,
             py::arg("epsilon") = -FLT_MAX,
             py::arg("result_expansion") = -FLT_MAX,
             py::arg("edge_size") = INT_MIN)
        .def("set_with_distance", &::QuantizedIndex::setWithDistance, py::arg("boolean") = true)
        .def("set",
             &::QuantizedIndex::set,
             py::arg("num_of_search_objects") = 0,
             py::arg("epsilon") = -FLT_MAX,
